...
// /v1/<user>/salamander/prekey/<scClientDevId>/?api_key=<API_key> - GET

static const std::string uriVersion ("/v1/");
static const std::string uriMe      ("me");
static const std::string uriUser    ("user");
static const std::string uriSalamander ("/salamander");
...
private:
     ...
     * For the SC implementation a request URL looks like this: 
     @verbatim
     /v1/<user>/salamander/prekey/<scClientDevId>/?api_key=<API_key>
     @endverbatim
     *
