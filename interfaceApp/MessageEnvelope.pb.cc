...
MessageEnvelope::MessageEnvelope()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:salamander.MessageEnvelope)
}
...
MessageEnvelope::MessageEnvelope(const MessageEnvelope& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:salamander.MessageEnvelope)
}
...
MessageEnvelope::~MessageEnvelope() {
  // @@protoc_insertion_point(destructor:salamander.MessageEnvelope)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:salamander.MessageEnvelope)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:salamander.MessageEnvelope)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:salamander.MessageEnvelope)
  return false;
#undef DO_
}
...
void MessageEnvelope::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:salamander.MessageEnvelope)
  // optional string name = 1;
  if (has_name()) {
  ...
  output->WriteRaw(unknown_fields().data(),
                   unknown_fields().size());
  // @@protoc_insertion_point(serialize_end:salamander.MessageEnvelope)
}
...
::std::string MessageEnvelope::GetTypeName() const {
  return "salamander.MessageEnvelope";
}
