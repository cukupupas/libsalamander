...
public:
     ...
     * to get the necessary Salamander data of the recipient, creates a session and sends the 
     * message.
     *
     ...
     * device regsieterd for Salamander usage. In this case the method returns a unique message id
    ...
    /**
     * @brief Request names of known trusted Salamander user identities
     *
     ...
     */
    virtual int32_t registerSalamanderDevice(string* result) = 0;
     ...
     *
     * Checks if a use has registered a new Salamander device
     *
     */
