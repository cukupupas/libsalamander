...
public:
    ...
    int32_t registerSalamanderDevice(string* result);

    int32_t removeSalamanderDevice(string& scClientDevId, string* result);
    ...
    /**
     * @brief Get name of local user for this Salamander conversation.
     */
