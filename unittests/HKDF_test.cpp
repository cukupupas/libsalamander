...
TEST(HKDF, Test1) {
    ...
    salamander::HKDF::deriveSecrets(ikm_t1, sizeof(ikm_t1), salt_t1, sizeof(salt_t1), info_t1, sizeof(info_t1), output, 42);
    for (int i = 0; i < 42; ++i) {
...
TEST(HKDF, Test2) {
    ...
    salamander::HKDF::deriveSecrets(ikm_t2, sizeof(ikm_t2), salt_t2, sizeof(salt_t2), info_t2, sizeof(info_t2), output, 82);
    for (int i = 0; i < 82; ++i) {
