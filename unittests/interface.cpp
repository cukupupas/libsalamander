...
*/
(replace-string "salamander" "salamander")
#include <limits.h>

#include "../storage/sqlite/SQLiteStoreConv.h"

#include "../salamander/crypto/Ec255PrivateKey.h"
...
TEST(RegisterRequest, Basic)
{
    ...
    std::string result;
    int32_t ret = uiIf.registerSalamanderDevice(&result);
...
/*
{
    ...
    "registrationId" : <int32_t>,        # the client's Salamander registration id
    "identityKey" :    <string>,         # public part encoded base64 data
    "deviceId" :       <int32_t>,        # the TextSecure (Salamander) device id if available, default 1
...
// This simulates an answer from the provisioning server repsonding a user's available Salamander devices
//
/*
 {
    "version" :        <int32_t>,        # Version of JSON new pre-keys, 1 for the first implementation
    "scClientDevIds" : [<string>, ..., <string>]   # array of known Salamander ScClientDevIds for this user/account
 }
 */
