...
# compile the Salamander and support modules, build the lib
include $(CLEAR_VARS)

LOCAL_CPP_FEATURES := @local_cpp_features@

# include paths for Salamander, protocol buffer and sqlite3 modules
...
LOCAL_C_INCLUDES += $(LOCAL_PATH)/salamander/crypto/ed25519 $(LOCAL_PATH)/salamander/crypto/ed25519/additions $(LOCAL_PATH)/salamander/crypto/ed25519/nacl_includes

# LOCAL_SRC_FILES := clients/tivi/android/jni/sqlite3/sqlite3.c
# LOCAL_SRC_FILES += buildinfo_$(TARGET_ARCH_ABI).c
LOCAL_SRC_FILES := @sal_src_spc@ 
