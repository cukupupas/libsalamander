...
/**
 * @file SalZrtpConnector.h
 * @brief Functions to link the Salamander protocol with a ZRTP client
 * @ingroup Salamander++
 * @{
 */
 ...
 * the Alice and Bob roles, stores the public key data according the the Salamander
 ...
 * data. The ZRTP based Salamander protocol uses this data as it's master secret
 * and dervies other keys from this master secret, refer to the Salamander specification.
 * 
...
public:
     ...
     * @param localConv Pointer to local Salamander state
     */
