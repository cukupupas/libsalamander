...
namespace salamander {
    ...
    static const int32_t NO_DEVS_FOUND  = -16;        //!< No registered Salamander devices found for a user
    ...
    static const int32_t AXO_CONV_EXISTS = -22;       //!< Salamander conversation exsists while tyring to setup new one
