...
/**
 * @file SalConversation.h
 * @brief The Salamander state of a conversation with a partner
 * 
 * This class manages the state of a Salamander conversation with a partner. It manages,
 * stores and retrieves keys and other state information. Refer to 
 * https://github.com/trevp/salamander/wiki to get a full description of all the state
 * information.
 * 
 * In this implementation we don't manage the header keys because we don't use header
 * encryption. This is a variant of the Salamander that the above document describes.
 * 
