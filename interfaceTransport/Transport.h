...
public:
     ...
     * more than one Salamander device then the function sends out all envelopes, one for each device.
     * 
     ...
     *
     * The network layer calls this function to forward a received Salamander message bundle. The network
